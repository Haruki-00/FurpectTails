...
Public Class admincalendarform
    ...
    Private Sub clndrbtn_Click(sender As Object, e As EventArgs) Handles clndrbtn.Click
    ...
    Private Sub MonthCalendar1_MouseLeave(sender As Object, e As EventArgs) Handles MonthCalendar1.MouseLeave
        MonthCalendar1.Visible = False
    End Sub
